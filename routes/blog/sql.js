...
const sql = {
  ...
  update: 'UPDATE blog set title=?, detail=?, desc=?, tag=? where titleId=?',
  delete: 'DELETE FROM blog WHERE titleId=?',
  queryByTitleId: 'SELECT title, author, authorId, logo, ctime, detail, tag, desc, coverImage FROM blog WHERE titleId=?',
